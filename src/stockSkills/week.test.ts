...
describe('Week', () => {
  ...
  describe('init', () => {
    it('應該正確初始化數據', () => {
      const data: StockType & { v: number } = { o: 100, c: 101, h: 102, l: 99, t: 20230501, v: 1000 };
  ...
  describe('next', () => {
    it('應該正確處理非週末的數據', () => {
      const initialData: StockType & { v: number } = { o: 100, c: 101, h: 102, l: 99, t: 20230501, v: 1000 };
      const nextData: StockType & { v: number } = { o: 101, c: 102, h: 103, l: 100, t: 20230502, v: 1100 };
    ...
    it('應該在週五時生成週數據', () => {
      ...
      for (let i = 2; i <= 5; i++) {
        const nextData: StockType & { v: number } = { o: 100 + i, c: 101 + i, h: 102 + i, l: 99 + i, t: 20230500 + i, v: 1000 + i * 100 };
    ...
    it('應該忽略週末數據', () => {
      const initialData: StockType & { v: number } = { o: 100, c: 101, h: 102, l: 99, t: 20230505, v: 1000 };
      const weekendData: StockType & { v: number } = { o: 101, c: 102, h: 103, l: 100, t: 20230506, v: 1100 };
      const initialResult = week.init(initialData);
    ...
    it('應該在新的一週開始時重置數據集', () => {
      const fridayData: StockType & { v: number } = { o: 100, c: 101, h: 102, l: 99, t: 20230505, v: 1000 };
      const mondayData: StockType & { v: number } = { o: 101, c: 102, h: 103, l: 100, t: 20230508, v: 1100 };
